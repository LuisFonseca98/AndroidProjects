...
public class ControllerScreen {
    ...
    public ControllerScreen(){
        ...
        Table upAction = new Table();
        upAction.right().bottom();
        ...
        upAction.add();
        upAction.row().padBottom(5);
        upAction.add(upImg).size(upImg.getWidth(), upImg.getHeight());

        upAction.setFillParent(true);
        stage.addActor(upAction);
    }
